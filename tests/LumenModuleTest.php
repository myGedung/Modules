...
class LumenModuleTest extends BaseTestCase
{
    ...
    {
        parent::setUp();
        $this->module = new LumenTestingModule($this->app, 'Recipe Name', __DIR__ . '/stubs/Recipe');
    }
    ...
    {
        (new LumenTestingModule($this->app, 'Recipe', __DIR__ . '/stubs/Recipe'))->boot();
    ...
    {
        $this->assertEquals('mygedung/recipe', $this->module->getComposerAttr('name'));
    }
...
class LumenTestingModule extends \myGedung\Modules\Lumen\Module
{
}
