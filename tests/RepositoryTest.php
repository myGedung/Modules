...
use myGedung\Modules\Collection;
use myGedung\Modules\Exceptions\InvalidAssetPath;
use myGedung\Modules\Exceptions\ModuleNotFoundException;
use myGedung\Modules\Module;
...
class RepositoryTest extends BaseTestCase
{
    ...
    {
        parent::setUp();
        $this->repository = new \myGedung\Modules\Laravel\Repository($this->app);
    }
    ...
    public function it_gets_the_configured_stubs_path_if_enabled()
    {
        ...
        $this->assertEquals(base_path('vendor/myGedung/laravel-modules/src/Commands/stubs'), $this->repository->getStubPath());
    }
