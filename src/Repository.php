...
use myGedung\Modules\Process\Installer;
use myGedung\Modules\Process\Updater;
...
abstract class Repository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \myGedung\Modules\Exceptions\ModuleNotFoundException
     */
